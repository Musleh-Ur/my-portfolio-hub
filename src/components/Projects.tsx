            ...
            <AnimatedSection key={project.id} animation="fade-up" delay={index * 100}>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col flex-1">
                  ...
                  {/* Project Media */}
                  <div className="mb-4 overflow-hidden rounded-md aspect-video bg-secondary/30">
                    {project.video && (
                      <video src={project.video} autoPlay loop muted playsInline className="w-full h-full object-contain rounded-md" />
                    )}
                    {project.image && !project.video && (
                      <img src={project.image} alt={project.title} loading="lazy" decoding="async" className="w-full h-full object-contain rounded-md" />
                    )}
