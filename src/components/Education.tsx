                ...
                <AnimatedSection key={edu.degree} animation="fade-up" delay={index * 150}>
                  ...
                  >
                    <img 
                      ...
                      className="absolute left-0 top-0 w-14 h-14 object-contain rounded-lg bg-white/10 p-1 group-hover:scale-110 transition-transform duration-300"
                    />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {edu.coursework.map((course) => (
                        <span
                          key={course}
                          className="px-2 py-1 text-xs rounded-md bg-secondary text-muted-foreground hover:bg-primary/15 hover:text-foreground hover:scale-105 transition-all duration-200 cursor-default"
                        >
                          {course}
                        </span>
                      ))}
